...
```{r}
paises_saa = world[world$continent == "South America" & world$area_km2 >= 2500000, ]
plot(
  paises_saa["area_km2"] , 
  main="Países de América del Sur con un área de al menos 2,5 millones de km2"
)
paises_sap = world[world$continent == "South America" & world$pop >= 40000000, ]
plot(
  paises_sap["pop"] , 
  main="Países de América del Sur con una población mayor o igual a 40 millones de personas"
)
```